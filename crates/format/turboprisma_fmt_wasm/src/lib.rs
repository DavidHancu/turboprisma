...
pub fn format(schema: String, params: String) -> String {
    register_panic_hook();
    turboprisma_fmt::format(&schema, &params)
}

/// Docs: https://prisma.github.io/prisma-engines/doc/turboprisma_fmt/fn.get_config.html
#[wasm_bindgen]
pub fn get_config(params: String) -> Result<String, JsError> {
    register_panic_hook();
    turboprisma_fmt::get_config(params).map_err(|e| JsError::new(&e))
}

/// Docs: https://prisma.github.io/prisma-engines/doc/turboprisma_fmt/fn.get_dmmf.html
#[wasm_bindgen]
pub fn get_dmmf(params: String) -> Result<String, JsError> {
    register_panic_hook();
    turboprisma_fmt::get_dmmf(params).map_err(|e| JsError::new(&e))
}

#[wasm_bindgen]
pub fn lint(input: String) -> String {
    register_panic_hook();
    turboprisma_fmt::lint(input)
}

#[wasm_bindgen]
pub fn validate(params: String) -> Result<(), JsError> {
    register_panic_hook();
    turboprisma_fmt::validate(params).map_err(|e| JsError::new(&e))
}

#[wasm_bindgen]
pub fn native_types(input: String) -> String {
    register_panic_hook();
    turboprisma_fmt::native_types(input)
}

#[wasm_bindgen]
pub fn referential_actions(input: String) -> String {
    register_panic_hook();
    turboprisma_fmt::referential_actions(input)
}

#[wasm_bindgen]
pub fn preview_features() -> String {
    register_panic_hook();
    turboprisma_fmt::preview_features()
}
...
pub fn text_document_completion(schema: String, params: String) -> String {
    register_panic_hook();
    turboprisma_fmt::text_document_completion(schema, &params)
}
...
pub fn code_actions(schema: String, params: String) -> String {
    register_panic_hook();
    turboprisma_fmt::code_actions(schema, &params)
}
...
pub fn debug_panic() {
    register_panic_hook();
    panic!("This is the panic triggered by `turboprisma_fmt::debug_panic()`");
}
